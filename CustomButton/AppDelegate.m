...
-(ButtonViewControl *)Button{
    return [[ButtonViewControl alloc]initWithNibName:@"ButtonViewControl" bundle:nil];
}

-(UINavigationController *)View{
    return [[UINavigationController alloc]initWithRootViewController:[self Button]];
}
